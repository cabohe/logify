    ...
    constructor( params, addTheme ){
        ...
        this.themes = {
            classic : {
                ...
                featStyle : "color:#333;padding:5px 0;font-size:18px;",
            ...
            light : {
                ...
                featStyle : "color:#747474;padding:5px 0;font-size:16px;",
            ...
            dark : {
                ...
                featStyle : "color:#D2D2D2;padding:5px 2px;font-size:16px;",
